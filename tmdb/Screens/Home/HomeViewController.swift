...
extension HomeViewController: HomeViewInputs{
    ...
    func prepareUI() {
        ...
        NSLayoutConstraint.activate([
            ...
            tvSearchResult.leading.constraint(equalTo: view.leading),
            tvSearchResult.trailing.constraint(equalTo: view.trailing),
            tvSearchResult.top.constraint(equalTo: view.top, constant: 70),
            tvSearchResult.bottom.constraint(equalTo: view.bottom),
