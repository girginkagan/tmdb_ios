//
//  DetailPersonMoviesTableViewCell.swift
//  tmdb
//
...
final class DetailPersonMoviesTableViewCell: UITableViewCell {

    var collectionView: UICollectionView!
    let layout = UICollectionViewFlowLayout()
    var collectionViewSource: DetailPersonMoviesCollectionViewSource?
    ...
    func setUI(){
        ...
        collectionView.register(DetailPersonMoviesCollectionViewCell.self, forCellWithReuseIdentifier: "DetailPersonMoviesCollectionViewCell")
    ...
    func updateCell(presenter: DetailPresenter, entities: DetailEntities){
        if collectionViewSource == nil{
            collectionViewSource = DetailPersonMoviesCollectionViewSource(presenter: presenter, entities: entities)
