//
//  DetailPersonTVsTableViewCell.swift
//  tmdb
//
...
final class DetailPersonTVsTableViewCell: UITableViewCell {

    var collectionView: UICollectionView!
    let layout = UICollectionViewFlowLayout()
    var collectionViewSource: DetailPersonTVsCollectionViewSource?
    ...
    func setUI(){
        ...
        collectionView.register(DetailPersonTVsCollectionViewCell.self, forCellWithReuseIdentifier: "DetailPersonTVsCollectionViewCell")
    ...
    func updateCell(presenter: DetailPresenter, entities: DetailEntities){
        if collectionViewSource == nil{
            collectionViewSource = DetailPersonTVsCollectionViewSource(presenter: presenter, entities: entities)
